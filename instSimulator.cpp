...
// instSimulator.cpp
//---------------------------------------------
// PGNS purportedly sent out by E80, along with
// whether I send them out below.
...
void depthInst::sendProtocols()
{
	...
	m_nmea2000->SendMsg(msg);
}


void logInst::sendProtocols()
{
	tN2kMsg msg;
...
void compassInst::sendProtocols()
{
	tN2kMsg msg;
	// PGN_VESSEL_HEADING
...
void autopilotInst::sendProtocols()
